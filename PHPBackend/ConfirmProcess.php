...
if(isset($_POST['Confirm_conf'])){
    $confirm_userID = $_POST['confirm_userID'];
     ...
     // Update tblresident
     $confirm_userID_query_resident = "UPDATE tblresident SET access = 'Approved' WHERE user_id = '$confirm_userID'";
     $confirm_userID_query_run_resident = mysqli_query($conn, $confirm_userID_query_resident);
 
     // Update tblaccounts
     $confirm_userID_query_accounts = "UPDATE tblaccounts SET access = 'Approved' WHERE user_id = '$confirm_userID'";
