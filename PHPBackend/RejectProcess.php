...
if(isset($_POST['reject_user'])){
    $reject_userID = $_POST['reject_userID'];
     ...
     // Update tblresident
     $reject_userID_query_resident = "UPDATE tblresident SET access = 'Rejected' WHERE user_id = '$reject_userID'";
     $reject_userID_query_run_resident = mysqli_query($conn, $reject_userID_query_resident);
 
     // Update tblaccounts
     $reject_userID_query_accounts = "UPDATE tblaccounts SET access = 'Rejected' WHERE user_id = '$reject_userID'";
