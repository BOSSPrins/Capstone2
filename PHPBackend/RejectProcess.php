...
if(isset($_POST['reject_user'])){
    $reject_userID = $_POST['reject_userID'];
     ...
     // Update tblresident
     $reject_userID_query_resident = "DELETE FROM tblresident WHERE unique_id = '$reject_userID'";
     $reject_userID_query_run_resident = mysqli_query($conn, $reject_userID_query_resident);
 
     // Update tblaccounts
     $reject_userID_query_accounts = "DELETE FROM tblaccounts WHERE unique_id = '$reject_userID'";
