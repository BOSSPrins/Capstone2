...
function sendBarangayEmail($user_email, $complaint_number, $Description) {
                    ...
                    <body>
                        <div class="modal">
                          <div class="logo">
                            ...
                            <p>Your complaint with number <strong>' . $complaint_number . '</strong> that has been turned over to the Barangay Salawag Community Hall for resolution. We are pleased to inform you that the matter has now been resolved.</p>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['complainantUID'])) {
    ...
    if ($email) {
        ...
        if (sendBarangayEmail($email, $complaint_number, $Description)) {
