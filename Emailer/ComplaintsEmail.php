...
function sendPendingEmail($user_email, $complaint_number, $Description) {
                    ...
                    <body>
                        <div class="modal">
                          <div class="logo">
                            ...
                            <h1>Complaint In Process</h1>
                            <p>Your complaint with number <strong>' . $complaint_number . '</strong> is currently being processed.</p>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['complainantUID'])) {
  ...
  $Description = $_POST['Description'];
    ...
    if ($email) {
        ...
        if (sendPendingEmail($email, $complaint_number, $Description)) {
